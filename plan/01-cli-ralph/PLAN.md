...
[ ] Make task bullets in plan/01-cli-ralph/PLAN_PARSING.md to carry out the plan in docs/PARSING.md, wiring to cli's -dparse, driven by the yaml tests, to ultimately reach equivelence on all supported syntax (-dparse matches).
[ ] Get plan/01-cli-ralph/PLAN_PARSING.md to 25% tasks done
