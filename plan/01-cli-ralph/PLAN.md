...
[ ] HEY! determine why this isn't dumping the parsed data `bin/ralph-cc testdata/example-c/all.c -dparse`
[ ] Manually spot check our parser cli againse ccert (using container-use) and review tests for any gaps including checking for parser commit diffs that don't add test cases (adding task bullets to plan/01-cli-ralph/PLAN_TEST.md if needed).
